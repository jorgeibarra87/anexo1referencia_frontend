                ...
                if (isEditMode && equipoOriginal && optionsData.length > 0) {
                    ...
                    if (nombreParts && nombreParts.length >= 3) {
                        ...
                        const foundOption = optionsData.find(option => {
                            const normalizedOption = (option.nombre || '').normalize('NFD').replace(/[\u0300-\u036f]/g, '').toUpperCase()
                                .replaceAll(/\s+/g, '_')
                                .replaceAll(/[^A-Z0-9_]/g, '');
                            return normalizedOption === optionName;
                        });
